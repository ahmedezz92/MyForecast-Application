package com.example.myforecastapplication.presentation.ui.components.camera.nopermission
...
private fun NoPermissionContent(
    ...
    Column(
        ...
        Button(onClick = onRequestPermission) {
            Icon(imageVector = Icons.Default.Place, contentDescription = "Camera")
